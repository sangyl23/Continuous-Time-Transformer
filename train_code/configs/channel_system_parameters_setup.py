...
def add_channel_system_args(parser):    
    # channel parameters
    parser.add_argument('--channel_type', type = str, default = 'demo',
                        choices = ['3GPP_38901', 'CDL-B', 'DeepMIMO_O1', 'demo'])
    parser.add_argument('--training_samples', type = str, default = '50mats',
                        choices = ['50mats', '100mats', '150mats'])
    ...
    parser.add_argument('--T_pre', type = float, default = 5.)
