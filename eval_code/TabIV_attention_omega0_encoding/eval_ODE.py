...
def main(training_time = args.training_time, epoch_num = args.epoch_num, b = args.batch_size, lr = args.lr, minlr = 1e-12):
    ...
    if args.result_idx == 'r1':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/CT_transformer_hybrid_with_standard_attention/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_standard_attention.mat'
        ...
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/CT_transformer_hybrid_with_hfpe_omega0_1/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_omega0_1.mat'
    elif args.result_idx == 'r5':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/CT_transformer_hybrid_with_hfpe_omega0_10/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_omega0_10.mat'
        ...
        mat_name = 'Eval_omega0_30.mat'
    elif args.result_idx == 'r7':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/CT_transformer_hybrid_with_hfpe_omega0_50/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_omega0_50.mat'
    else:
