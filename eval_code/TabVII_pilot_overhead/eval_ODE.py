...
def main(training_time = args.training_time, epoch_num = args.epoch_num, b = args.batch_size, lr = args.lr, minlr = 1e-12):
    ...
    if args.channel_type == '3GPP_38901':
        ...
        path_eval = '../../3GPP_dataset/' + args.UE_velocity + '/test_opt2_doppler_random'
    ...
    if args.result_idx == 'r1':         
        ...
        model_path = '../../checkpoint/3GPP_60kmh/uniform_pilot/CT_transformer_hybrid_pilot_overhead36/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_uniform_pilot_overhead36.mat'
