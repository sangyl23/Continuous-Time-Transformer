...
def main(training_time = args.training_time, epoch_num = args.epoch_num, b = args.batch_size, lr = args.lr, minlr = 1e-12):
    ...
    if args.result_idx == 'r1':         
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/GRU_vector_wise/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_Vanilla_GRU_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_GRU_vector.mat'
        ...
        mat_name = 'Eval_GRU_element.mat'
    elif args.result_idx == 'r3':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/Vanilla_transformer_vector_wise/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_Vanilla_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Vanilla_transformer_vector.mat'
        ...
        mat_name = 'Eval_Vanilla_transformer_element.mat'
    elif args.result_idx == 'r5':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/Neural_ODE_vector_wise/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_Neural_ODE_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Neural_ODE_vector.mat'
        ...
        mat_name = 'Eval_Neural_ODE_element.mat'
    elif args.result_idx == 'r7':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/Latent_ODE_vector_wise/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_Latent_ODE_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Latent_ODE_vector.mat'
        ...
        mat_name = 'Eval_Latent_ODE_element.mat'
    elif args.result_idx == 'r9':
        model_path = '../../checkpoint/3GPP_60kmh/chebyshev_pilot/CT_transformer_hybrid_vector_wise/inregular_pilot(v60kmh,snr10dB,lr0.0005)_3GPP_38901_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_CT_transformer_vector.mat'
        ...
        mat_name = 'Eval_CT_transformer_element.mat'
    else:
