...
def add_model_args(parser):    
    # model parameters
    # parser.add_argument('--model_name', type = str, default = 'Latent_ODE',
    ...
    parser.add_argument('--instance_norm', type = str, default = 'norm_2',
    ...
    # ode parameters
    parser.add_argument('--enc_ode_h', type = int, default = 64, help = 'encoder ode hidden size')
    parser.add_argument('--enc_ode_hidden_layers', type = int, default = 2, help = 'encoder ode hidden layer number')
    parser.add_argument('--dec_ode_h', type = int, default = 64, help = 'decoder ode hidden size')
    parser.add_argument('--dec_ode_hidden_layers', type = int, default = 2, help = 'decoder ode hidden layer number')
    parser.add_argument('--ode_rnn_type', type = str, default = 'GRU',
                        choices = ['RNN', 'LSTM', 'GRU'])
    parser.add_argument('--enc_dec_odefunc_ifshared', type = eval, default = False)
