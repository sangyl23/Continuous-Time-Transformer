...
def main(training_time = args.training_time, epoch_num = args.epoch_num, b = args.batch_size, lr = args.lr, minlr = 1e-12):
    ...
    if args.channel_type == '3GPP_38901':
        ...
        path_eval = '../../' + args.UE_velocity + '/test_opt2_doppler_random'
    
    elif args.channel_type == 'DeepMIMO_O1':

        path_eval = '../../' + 'deepmimo_dataset/preprocessed_csi_prediction_dataset/test_opt2_' + args.snr + '_10mats'
    ...
    if args.result_idx == 'r1':
        model_path = '../../checkpoint/deepmimo_60kmh/GRU/inregular_pilot(v60kmh,snr10dB,lr0.0005)_DeepMIMO_O1_Vanilla_GRU_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_GRU_' + args.snr + '.mat'
    elif args.result_idx == 'r2':
        model_path = '../../checkpoint/deepmimo_60kmh/Vanilla_transformer/inregular_pilot(v60kmh,snr10dB,lr0.0005)_DeepMIMO_O1_Vanilla_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Vanilla_transformer_' + args.snr + '.mat'
    elif args.result_idx == 'r3':
        model_path = '../../checkpoint/deepmimo_60kmh/Neural_ODE/inregular_pilot(v60kmh,snr10dB,lr0.0005)_DeepMIMO_O1_Neural_ODE_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Neural_ODE_' + args.snr + '.mat'
    elif args.result_idx == 'r4': 
        model_path = '../../checkpoint/deepmimo_60kmh/Latent_ODE/inregular_pilot(v60kmh,snr10dB,lr0.0005)_DeepMIMO_O1_Latent_ODE_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_Latent_ODE_' + args.snr + '.mat'
    elif args.result_idx == 'r5':         
        model_path = '../../checkpoint/deepmimo_60kmh/CT_transformer_hybrid/inregular_pilot(v60kmh,snr10dB,lr0.0005)_DeepMIMO_O1_CT_Transformer_NMSE_tt0_MODEL.pth'
        mat_name = 'Eval_CT_transformer_hybrid_' + args.snr + '.mat'
    else:
